...
public final class TelemetryClient {
    ...
    // The focus of the exercise is on the other class.
    //
    ...
    public void send(String message) {
        ...
        // The simulation of send().
        // Actually just remember if the last message sent was a diagnostic message.
        // This information will be used to simulate the Receive(). There is no real server listening.
