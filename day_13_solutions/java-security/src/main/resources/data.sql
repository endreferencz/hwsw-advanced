insert into user(id,email,first_name,last_name, admin, password) values (0,'peter@example.com','Peter','X', true, '$2a$04$LUWtAY5fnOOQJrXXiVCCsO32xqRtVnPM8k5gNuHdz4NvZQrOTFb9.');
insert into user(id,email,first_name,last_name, admin, password) values (1,'andrew@example.com','Andrew','Y', false, '$2a$04$LUWtAY5fnOOQJrXXiVCCsO32xqRtVnPM8k5gNuHdz4NvZQrOTFb9.');
